...
gdown.download(model_url, os.path.join(scgpt_configs['load_model_dir'],
                                       scgpt_configs['model_file_name']), quiet=False)
gdown.download(args_url, os.path.join(scgpt_configs['load_model_dir'], 'args.json'), quiet=False)
gdown.download(vocab_url, os.path.join(scgpt_configs['load_model_dir'], 'vocab.json'), quiet=False)
